 ...
 * The HTML page should call PUT on the device's update URL to apply the configuration changes.
 * Each device has an HTML endpoint of the form '/setup/v1/{deviceType}/{deviceID}/setup'.
 */
